...
| CadenceHook | `0x64E775DE6C8921b693aA0622a8A202d43030C088` | `0x90d1c3C9517c389B77De80B255105E0fbA120088` |
| CadenceSlots (ERC-1155) | `0xdFddf5E21D61256ce8470E8431eE2AB85d0727B3` | `0xdFddf5E21D61256ce8470E8431eE2AB85d0727B3` |
| Router + registry | `0xD5b4654fbaB42e51BD8C1262565597d6DAc58804` | `0x19Dd2d0Ff570aF287E403b19Ef28dc31c4518B04` |
| CLOB | `0x04Ab90027f73fDBa1E569Ded8d9Ab218707cc3d8` | `0x022BEf39902d366d62655a6D5E16d48Bf0b7e8c2` |
| Quote token (cUSDC 18) | `0x7d7890553Dd2998137deb78aAFD9e2eA4630DF54` | `0xD7CA46a70b2F5bc5ed13F211d21981e59cB568eB` |
...
| `/privacy` | Private Cadence Intent (commit→reveal) + stealth payer; Railgun fund path **wired behind env gating** (real SDK flow, NotWired when RAILGUN_* unset); Aztec pending node env |
...
| 7 | Aztec / Railgun fund path (shields funds, not the swap) — Railgun **wired behind env gating** (real SDK; skip-when-unset tested), Aztec pending AZTEC_* env | `/privacy` + `lib/shield` |
